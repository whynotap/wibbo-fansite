<template>
	<header>
		<div>
			<img src="@/assets/imgs/icon_wb.gif" />

			<img src="@/assets/imgs/" />

			<button type="button"><img src="@/assets/imgs/" />Administration</button>
		</div>
		<nav>
			<ul>
				<li>
				...
				<div>
					...
					<li>
						<img src="@/assets/imgs/commu.png" /><span>Communauté</span>
					</li>
					<ul>
						<li>Articles</li>
						<li>Équipe</li>
	...
	<section class="grid">
		<div>
			...
			<div>
				<p>Python</p>
				<p>
					<img src="@/assets/imgs/mottohome.gif" />Python vous souhaite la
					bienvenue sur notre fansite officiel
				</p>
			</div>
		</div>
		...
		<div>
			<h5>Version bêta</h5>
			<p>
				Notre version bêta débarque et reste temporaire le temps du
				développement.
			</p>
			<a href="#"><button type="button">Lire la suite »</button></a>
		</div>

		<div>
			<h5>Bienvenue sur Wibbo'Up !</h5>
			<p>Et oui, enfin..</p>
			<a href="#"><button type="button">Lire la suite »</button></a>
		</div>
	...
	<footer>
		<p>&copy; <b>Copyright</b> 2023 - Tout droits réservées. Wibbo'Up</p>
	</footer>
</template>
